...
it('can add the star name and star symbol properly', async() => {
    ...
    let tokenId = 6;
    await instance.createStar('awesome star', tokenId, {from: user1});
    assert.equal(await instance.name.call(),"AhmedStars Token");
    assert.equal(await instance.symbol.call(),"ASM");
});
...
it('lets 2 users exchange stars', async() => {
    ...
    await instance.createStar('fabulous star', tokenId2, {from: user2});
